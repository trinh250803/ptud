    ...
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-8">
            <h3 style="margin-bottom:30px; font-family: Montserrat, sans-serif;" class="d-flex justify-content-center align-items-center"><strong>Đăng nhập</strong></h3>
            ...
            <div class="col-md-12 d-flex justify-content-center align-items-center login__item">
                <a class=" login-decent__member text-white d-flex justify-content-center align-items-center col-md-6 mt-5 mx-4 border text-decoration-none text-center login__item-links" href="./dangnhap-tv.php">Thành viên</a>
                <a class=" login-decent__member text-white d-flex justify-content-center align-items-center col-md-6 mt-5 mx-4 border text-decoration-none text-center login__item-links" href="./dangnhap-nv.php">Nhân viên</a>
            </div>
