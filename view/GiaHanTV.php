        ...
        <div class="right">
            <div class="update-info-container">
                ...
                <form>
                    ...
                    <select id="membership-plan" name="membership-plan">
                        <option value="1-month">Gói 1 tháng</option>
                        <option value="3-months">Gói 3 tháng</option>
                        <option value="6-months">Gói 6 tháng</option>
                        <option value="12-months">Gói 12 tháng</option>
                    </select>

                    <!-- Hiển thị chi tiết gói -->
                    <div class="package-details">
                        <p><strong>Thông tin chi tiết gói tập:</strong></p>
                        <p>Thời hạn: 3 tháng</p>
                        <p>Quyền lợi: Sử dụng phòng tập không giới hạn, 3 buổi huấn luyện miễn phí</p>
                        <p>Giá: 1,500,000 VND</p>
                    </div>

                    <!-- Nút Gia hạn -->
                    <button type="button" id="renew-button">Gia hạn</button>
