...
<head>
    ...
    <link rel="stylesheet" href="./assets/bootstrap-4.5.3-dist/css/bootstrap-grid.min.css">
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            <a href="" class="navbar-brand">
                <h1 class="m-0 display-4 font-weight-bold text-uppercase text-white ml-4">LifeGym</h1>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between " id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4 bg-secondary ">
                    ...
                    <a href="./view/feature.php" class="nav-item nav-link">Tin tức- Sự kiện</a>
                    <a href="./view/class.php" class="nav-item nav-link">Classes</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu text-capitalize">
                            <a href="./view/blog.php" class="dropdown-item">Blog Grid</a>
                            <a href="./view/.php" class="dropdown-item">Blog Detail</a>
                        </div>
                    </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <a href="./view/Login_v3/dangnhap.php" class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Join Us Now</a>
                    </div>
                </div>
        ...
        <div class="row px-3">
            <div class="col-md-6 p-0">
                <div class="gym-class-box d-flex flex-column align-items-end justify-content-center bg-primary text-right text-white py-5 px-5">
                    ...
                    <a href="./view/Login_v3/dangnhap.php" class="btn btn-lg btn-outline-light mt-4 px-4">Join Now</a>
                </div>
            </div>
            <div class="col-md-6 p-0">
    ...
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <a href="./view/Login_v3/dangnhap.php" class="btn btn-lg px-4 btn-outline-primary">Learn More</a>
            </div>
        </div>
    </div>
    <!-- About End -->
